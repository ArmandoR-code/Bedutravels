...
SECRET_KEY = 'django-insecure-agc#j@rczdwmgj*@17hey8%!=z0*%juq#u^0z9^+&-k^k47(l9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["armyr.pythonanywhere.com"]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ArmyR$Bedutravels',
        'USER': 'ArmyR',
        'PASSWORD': 'pythonsql',
        'HOST': 'ArmyR.mysql.pythonanywhere-services.com',
    }
}
